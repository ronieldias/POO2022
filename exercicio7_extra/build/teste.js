...
const ex07_q04_extra_1 = require("./ex07_q04_extra");
/*
...
*/
let p1 = new ex07_q02_extra_1.Pessoa('Leana', 'Ellen');
let f1 = new ex07_q03_extra_1.Funcionario('Andre', 'Marques', '123', -1000);
let f2 = new ex07_q03_extra_1.Funcionario('Carlos', 'Henrique', '123', 500);
let f3 = new ex07_q03_extra_1.Funcionario('Junior', 'Pebinha', '123', 1000);
let prof1 = new ex07_q04_extra_1.Professor('Gilberto', 'Barros', '123', -1000, 'Doutor');
let prof2 = new ex07_q04_extra_1.Professor('Edvaldo', 'Lages', '123', 500, 'Mestre');
let prof3 = new ex07_q04_extra_1.Professor('Gildásio', 'Guedes', '123', 1000, 'Licenciatura');
let array = [p1, f1, f2, f3, prof1, prof2, prof3];
for (let i = 0; i < array.length; i++) {
    console.log(`\nNome: ${array[i].nome}\n` +
        `Sobrenome: ${array[i].sobrenome}\n` +
        `Nome Completo: ${array[i].nomeCompleto}`);
    if (array[i] instanceof ex07_q03_extra_1.Funcionario || array[i] instanceof ex07_q04_extra_1.Professor) {
        ...
        if (array[i] instanceof ex07_q04_extra_1.Professor) {
